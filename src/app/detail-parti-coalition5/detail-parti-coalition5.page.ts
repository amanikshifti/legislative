...
@Component({
  selector: 'app-detail-parti-coalition5',
  templateUrl: './detail-parti-coalition5.page.html',
  styleUrls: ['./detail-parti-coalition5.page.scss'],
})
export class DetailPartiCoalition5Page implements OnInit {
  ...
  elu;
    ...
    nom: any;
      ...
      DetailsElu(eluCc) {
        ...
        this.router.navigate(['/profil-coalition5'], navigationExtras);
      }
