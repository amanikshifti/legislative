...
@Component({
  selector: 'app-detail-parti-coalition4',
  templateUrl: './detail-parti-coalition4.page.html',
  styleUrls: ['./detail-parti-coalition4.page.scss'],
})
export class DetailPartiCoalition4Page implements OnInit {
  ...
  elu;
    ...
    nom: any;
      ...
      DetailsElu(eluCc) {
        ...
        this.router.navigate(['/profil-coalition4'], navigationExtras);
      }
