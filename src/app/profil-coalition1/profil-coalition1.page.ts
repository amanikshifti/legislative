...
@Component({
  selector: 'app-profil-coalition1',
  templateUrl: './profil-coalition1.page.html',
  styleUrls: ['./profil-coalition1.page.scss'],
})
export class ProfilCoalition1Page implements OnInit {
  ...
  id: any;
    ...
    all(eluC) {
      ...
      this.router.navigate(['/detail-parti-coalition1'], navigationExtras);
    }
