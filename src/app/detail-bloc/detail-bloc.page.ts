...
@Component({
  ...
  templateUrl: './detail-bloc.page.html',
  styleUrls: ['./detail-bloc.page.scss'],
})
export class DetailBlocPage implements OnInit {
  id_b;
  nomB;
  eluC;
  eluCc;
  ...
  DetailsElu(eluCc) {
    ...
    this.router.navigate(['/profil-bloc'], navigationExtras);
  }
