...
@Component({
  selector: 'app-profil-coalition6',
  templateUrl: './profil-coalition6.page.html',
  styleUrls: ['./profil-coalition6.page.scss'],
})
export class ProfilCoalition6Page implements OnInit {
