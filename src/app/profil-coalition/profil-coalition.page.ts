...
@Component({
  selector: 'app-profil-coalition',
  templateUrl: './profil-coalition.page.html',
  styleUrls: ['./profil-coalition.page.scss'],
})
export class ProfilCoalitionPage implements OnInit {
