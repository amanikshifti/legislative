...
@Component({
  selector: 'app-profil-coalition4',
  templateUrl: './profil-coalition4.page.html',
  styleUrls: ['./profil-coalition4.page.scss'],
})
export class ProfilCoalition4Page implements OnInit {
  ...
  id: any;
    ...
    all(eluC) {
      ...
      this.router.navigate(['/detail-parti-coalition4'], navigationExtras);
    }
