...
@Component({
  selector: 'app-detail-parti-coalition6',
  templateUrl: './detail-parti-coalition6.page.html',
  styleUrls: ['./detail-parti-coalition6.page.scss'],
})
export class DetailPartiCoalition6Page implements OnInit {
  eluCc;
  newUrl:string;
  bureau;
  id_b;
