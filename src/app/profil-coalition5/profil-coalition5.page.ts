...
@Component({
  selector: 'app-profil-coalition5',
  templateUrl: './profil-coalition5.page.html',
  styleUrls: ['./profil-coalition5.page.scss'],
})
export class ProfilCoalition5Page implements OnInit {
  ...
  id: any;
    ...
    all(eluC) {
      ...
      this.router.navigate(['/detail-parti-coalition5'], navigationExtras);
    }
