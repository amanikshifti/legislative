...
@Component({
  selector: 'app-profil-coalition3',
  templateUrl: './profil-coalition3.page.html',
  styleUrls: ['./profil-coalition3.page.scss'],
})
export class ProfilCoalition3Page implements OnInit {
  ...
  id: any;
    ...
    all(eluC) {
      ...
      this.router.navigate(['/detail-parti-coalition3'], navigationExtras);
    }
