...
@Component({
  selector: 'app-detail-com-x',
  templateUrl: './detail-com-x.page.html',
  styleUrls: ['./detail-com-x.page.scss'],
})

export class DetailComXPage implements OnInit {
  id_c: any;
  nomc: any;
  eluC;
  eluCc;
  ...
  ngOnInit() {
    this.apiService.getEluParCommission(this.nomc).subscribe((data) => {
      console.log(this.nomc);
      this.eluC = data;
      this.eluCc = data;
    ...
    this.newUrl = 'http://legislative-2019.tn/apiEluParCommission/' + this.nomc;
  ...
  DetailsElu(eluCc) {
    ...
    this.router.navigate(['/profil-comi2'], navigationExtras);
  }
