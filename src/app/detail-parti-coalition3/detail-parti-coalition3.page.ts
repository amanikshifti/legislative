...
@Component({
  selector: 'app-detail-parti-coalition3',
  templateUrl: './detail-parti-coalition3.page.html',
  styleUrls: ['./detail-parti-coalition3.page.scss'],
})
export class DetailPartiCoalition3Page implements OnInit {
  ...
  elu;
    ...
    nom: any;
      ...
      DetailsElu(eluCc) {
        ...
        this.router.navigate(['/profil-coalition3'], navigationExtras);
      }
