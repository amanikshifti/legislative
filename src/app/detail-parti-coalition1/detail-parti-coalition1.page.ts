...
@Component({
  selector: 'app-detail-parti-coalition1',
  templateUrl: './detail-parti-coalition1.page.html',
  styleUrls: ['./detail-parti-coalition1.page.scss'],
})
export class DetailPartiCoalition1Page implements OnInit {
...
elu;
  ...
  nom: any;
    ...
    DetailsElu(eluCc) {
      ...
      this.router.navigate(['/profil-coalition1'], navigationExtras);
    }
    ...
    DetailsElu1(eluCc) {
      ...
      this.router.navigate(['/profil-coalition6'], navigationExtras);
    }
