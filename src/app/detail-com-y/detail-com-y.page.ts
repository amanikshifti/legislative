...
@Component({
  selector: 'app-detail-com-y',
  templateUrl: './detail-com-y.page.html',
  styleUrls: ['./detail-com-y.page.scss'],
})
export class DetailComYPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.apiService.getEluParCommissionSP(this.nomc).subscribe((data) => {
      console.log(this.nomc);
      this.eluC = data;
      this.eluCc = data;
    ...
    this.newUrl = 'http://legislative-2019.tn/apiEluParCommissionSP/' + this.nomc;
  ...
  DetailsElu(eluCc) {
    ...
    this.router.navigate(['/profil-comi3'], navigationExtras);
  }
